# monodepth
Tensorflow Slim implementation of unsupervised single image depth prediction using a convolutional neural network.

_Jan 2018_
Updated repo with README of the official implementation.

This repository differs in usage of tensorflow slim.

Official Implementation [http://visual.cs.ucl.ac.uk/pubs/monoDepth/].
<p align="center">
...
There is a simple mode `monodepth_simple.py` which allows you to quickly run the  model on a test image.  
